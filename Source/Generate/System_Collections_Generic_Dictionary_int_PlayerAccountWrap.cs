...
public class System_Collections_Generic_Dictionary_int_PlayerAccountWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(System.Collections.Generic.Dictionary<int,PlayerAccount>), typeof(System.Object), "AccountMap");
		...
		L.RegFunction("New", _CreateSystem_Collections_Generic_Dictionary_int_PlayerAccount);
	...
	static int _CreateSystem_Collections_Generic_Dictionary_int_PlayerAccount(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				System.Collections.Generic.Dictionary<int,PlayerAccount> obj = new System.Collections.Generic.Dictionary<int,PlayerAccount>();
			...
			else if (count == 1 && TypeChecker.CheckTypes<int>(L, 1))
			{
				...
				System.Collections.Generic.Dictionary<int,PlayerAccount> obj = new System.Collections.Generic.Dictionary<int,PlayerAccount>(arg0);
				ToLua.PushSealed(L, obj);
				return 1;
			}
			else if (count == 1 && TypeChecker.CheckTypes<System.Collections.Generic.IDictionary<int,PlayerAccount>>(L, 1))
			{
				System.Collections.Generic.IDictionary<int,PlayerAccount> arg0 = (System.Collections.Generic.IDictionary<int,PlayerAccount>)ToLua.ToObject(L, 1);
				System.Collections.Generic.Dictionary<int,PlayerAccount> obj = new System.Collections.Generic.Dictionary<int,PlayerAccount>(arg0);
				ToLua.PushSealed(L, obj);
				return 1;
			}
			...
			else if (count == 2 && TypeChecker.CheckTypes<int, System.Collections.Generic.IEqualityComparer<int>>(L, 1))
			{
				...
				System.Collections.Generic.Dictionary<int,PlayerAccount> obj = new System.Collections.Generic.Dictionary<int,PlayerAccount>(arg0, arg1);
				ToLua.PushSealed(L, obj);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes<System.Collections.Generic.IDictionary<int,PlayerAccount>, System.Collections.Generic.IEqualityComparer<int>>(L, 1))
			{
				System.Collections.Generic.IDictionary<int,PlayerAccount> arg0 = (System.Collections.Generic.IDictionary<int,PlayerAccount>)ToLua.ToObject(L, 1);
				System.Collections.Generic.IEqualityComparer<int> arg1 = (System.Collections.Generic.IEqualityComparer<int>)ToLua.ToObject(L, 2);
				System.Collections.Generic.Dictionary<int,PlayerAccount> obj = new System.Collections.Generic.Dictionary<int,PlayerAccount>(arg0, arg1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: System.Collections.Generic.Dictionary<int,PlayerAccount>.New");
			}
		}
		catch (Exception e)
		{
	...
	static int _get_this(IntPtr L)
	{
		try
		{
			...
			System.Collections.Generic.Dictionary<int,PlayerAccount> obj = (System.Collections.Generic.Dictionary<int,PlayerAccount>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.Dictionary<int,PlayerAccount>));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
			PlayerAccount o = obj[arg0];
	...
	static int _set_this(IntPtr L)
	{
		try
		{
			...
			System.Collections.Generic.Dictionary<int,PlayerAccount> obj = (System.Collections.Generic.Dictionary<int,PlayerAccount>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.Dictionary<int,PlayerAccount>));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
			PlayerAccount arg1 = (PlayerAccount)ToLua.CheckObject<PlayerAccount>(L, 3);
			obj[arg0] = arg1;
			return 0;
	...
	static int ContainsValue(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			System.Collections.Generic.Dictionary<int,PlayerAccount> obj = (System.Collections.Generic.Dictionary<int,PlayerAccount>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.Dictionary<int,PlayerAccount>));
			PlayerAccount arg0 = (PlayerAccount)ToLua.CheckObject<PlayerAccount>(L, 2);
	...
	static int get_Count(IntPtr L)
	{
		...
		try
		{
			...
			System.Collections.Generic.Dictionary<int,PlayerAccount> obj = (System.Collections.Generic.Dictionary<int,PlayerAccount>)o;
			int ret = obj.Count;
	...
	static int get_Keys(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			System.Collections.Generic.Dictionary<int,PlayerAccount> obj = (System.Collections.Generic.Dictionary<int,PlayerAccount>)o;
			System.Collections.Generic.Dictionary<int,PlayerAccount>.KeyCollection ret = obj.Keys;
	...
	static int get_Values(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			System.Collections.Generic.Dictionary<int,PlayerAccount> obj = (System.Collections.Generic.Dictionary<int,PlayerAccount>)o;
			System.Collections.Generic.Dictionary<int,PlayerAccount>.ValueCollection ret = obj.Values;
			ToLua.PushSealed(L, ret);
			return 1;
		}
		catch(Exception e)
